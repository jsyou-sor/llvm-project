...
set(ALL_ZOMTAG_SUPPORTED_ARCH ${X86_64} ${ARM64})
if(APPLE)
...
if(APPLE)
  ...
  list_intersect(SAFESTACK_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(ZOMTAG_SUPPORTED_ARCH
		ALL_ZOMTAG_SUPPORTED_ARCH
		SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(SAFESTACK_SUPPORTED_ARCH
    ${ALL_SAFESTACK_SUPPORTED_ARCH})
  filter_available_targets(ZOMTAG_SUPPORTED_ARCH ${ALL_ZOMTAG_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan;zomtag)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND TESTSAN_SUPPORTED_ARCH AND
		OS_NAME MATCHES "Linux")
	set(COMPILER_RT_HAS_ZOMTAG TRUE)
else()
	set(COMPILER_RT_HAS_ZOMTAG FALSE)
endif()
