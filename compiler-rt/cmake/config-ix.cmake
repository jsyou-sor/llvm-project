...
set(ALL_SGXBOUNDS_SUPPORTED_ARCH ${X86_64} ${ARM64})
...
if(APPLE)
  ...
  list_intersect(ZOMTAG_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
	list_intersect(SGXBOUNDS_SUPPORTED_ARCH
		ALL_SGXBOUNDS_SUPPORTED_ARCH
		SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(ZOMTAG_SUPPORTED_ARCH ${ALL_ZOMTAG_SUPPORTED_ARCH})
	filter_available_targets(SGXBOUNDS_SUPPORTED_ARCH ${ALL_SGXBOUNDS_SUPPORTED_ARCH})
