...
set(ALL_TESTAN_SUPPORTED_ARCH ${ARM64})
...
if(APPLE)
  ...
  list_intersect(TESTSAN_SUPPORTED_ARCH
		ALL_TESTSAN_SUPPORTED_ARCH
  ...
  filter_available_targets(UBSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(TESTSAN_SUPPORTED_ARCH
		${SANITIZER_COMMON_SUPPORTED_ARCH})
	message([STATUS] "after filter " ${TESTSAN_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan;testsan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND TESTSAN_SUPPORTED_ARCH AND
		OS_NAME MATCHES "Linux")
	set(COMPILER_RT_HAS_TESTSAN TRUE)
else()
	set(COMPILER_RT_HAS_TESTSAN FALSE)
endif()
